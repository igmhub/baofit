...
namespace baofit {
	...
	public:
        ...
        // sample to the specified filename, if one is provided. See doBootstrapAnalysis
        // for a description of the other parameters.
        int doMCSampling(int ngen, std::string const &mcConfig, std::string const &mcSaveFile,
