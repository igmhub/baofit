...
double rmin, double rmax, double muMin, double muMax, double zMin, double zMax, double llmin,
...
{
  _initialize(rmin,rmax,muMin,muMax,zMin,zMax,llmin,rVetoMin,rVetoMax,fixCov,cosmology);
}
