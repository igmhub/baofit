...
_verbose(verbose)
{
    ...
    try {
        ...
        throw RuntimeError("BaoKSpaceHybridCorrelationModel: error while reading tabulated P(k) data.");
    }
...
double local::BaoKSpaceHybridCorrelationModel::_evaluateKSpaceDistortion(double k, double mu_k, double pk) const {
...
bool anyChanged) const {
    ...
    // Redo the hybrid transformation from k-space to r-space if necessary
    if(anyChanged) {
